...
public class HexadecimalSudokuTest {
  ...
  public static void main(String[] arg) {
    ...
    /*
     * To further test the solveSudoku method, I added a few sudokus with special circumstances, they all are variants
     * of the provided example1 sudoku, and share the same solutions.
     * First test (Lines 214-229) should always fail because it's an invalid sudoku.
     * Second test (Lines 231-246) should give the same answer as example1, as it's the same sudoku, 
     * but a few numbers were removed.
     * Third test  (Lines 249-254) creates an empty sudoku board, my program should always solve it.
     */
    int[][] test1 = { { 12, 12, 12, 12, 12, 12, 9, -1, 6, 14, -1, 1, -1, 3, -1, -1 },
                      { 14, -1, 0, 9, -1, -1, 2, 12, 13, -1, 3, -1, 15, -1, -1, -1 },
                      { 1, -1, -1, -1, -1, -1, 7, -1, -1, 9, -1, 2, 11, 5, 14, 0 },
                      { 13, 8, -1, -1, 5, -1, -1, 0, -1, -1, 15, -1, -1, 9, -1, 2 },
                      { 0, 7, 14, 2, -1, -1, -1, 9, -1, -1, -1, 5, -1, -1, 3, 15 },
    ...
    int[][] test2 = { { -1, -1, 5, -1, 4, -1, 9, -1, 6, 14, -1, 1, -1, 3, -1, -1 },
                      { 14, -1, 0, 9, -1, -1, 2, 12, 13, -1, 3, -1, 15, -1, -1, -1 },
                      { 1, -1, -1, -1, -1, -1, 7, -1, -1, 9, -1, 2, 11, 5, 14, 0 },
                      { 13, 8, -1, -1, 5, -1, -1, 0, -1, -1, 15, -1, -1, 9, -1, 2 },
                      { 0, 7, 14, 2, -1, -1, -1, 9, -1, -1, -1, 5, -1, -1, 3, 15 },
                      ...
                      { 6, 11, -1, -1, -1, 15, -1, -1, -1, 12, 9, 3, -1, -1, 10, -1 },
                      { 2, -1, -1, -1, 3, 7, 11, 4, 5, -1, -1, -1, 0, 13, -1, 8 },
                      { 7, 6, 12, 8, -1, -1, -1, -1, 0, -1, -1, 11, 4, -1, -1, -1 },
                      { 4, 9, 3, -1, -1, -1, -1, -1, 15, -1, 12, 7, 6, -1, 1, -1 },
                      { 10, -1, 11, -1, 15, -1, 12, 1, 3, -1, -1, 14, 9, 7, -1, -1 },
                      { 9, -1, 2, -1, 7, 4, 0, -1, -1, -1, 5, -1, -1, 8, 13, -1 },
                      { 8, 3, 7, -1, -1, 9, 6, -1, 12, -1, -1, -1, -1, -1, -1, 14 },
    ...
    testSudoku("test 1", test1, solution1);
    testSudoku("test 2", test2, solution1);
    testSudoku("test 3", test3, solution1);
